...
| `Farm/IslandView.cs` | Một đảo: ô đất (kể cả giọt nước khát), rào, vật trang trí từng đảo (`Places`), gieo/tưới/thu hoạch và hiệu ứng |
| `Farm/DecorCatalog.cs` | **Sinh bởi `Tools/slice_decor.py`**: chân, đèn, biến thể nền, cánh quay của vật trang trí vẽ tay (`Art/decor`) |
...
| `UI/SkyView.cs`, `CloudMaterials.cs`, `DayCycle.cs`, `WeatherFx.cs` | Bầu trời, mây (shader `UICloud`: xám = ánh sáng, trôi/thở trên GPU), ngày/đêm theo giờ máy, hiệu ứng thời tiết |
